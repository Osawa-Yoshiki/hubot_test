module.exports = (robot) ->
  ...
  robot.respond /状況を#(.*)に通知して/i, (msg) ->
    request = msg.http("https://slack.com/api/chat.postMessage?token=xoxp-239710252337-240366548533-243849728260-d84df4c9a2de86dd0a934db6392a91fe&icon_url=https://goo.gl/udYNSb&channel=%23#{msg.match[1]}&username=motionbot&text=見込みが減少しました。&as_user=false")
                          .get()
    request (err, res, body) ->
      json = JSON.parse body
      msg.send "承知しました"
