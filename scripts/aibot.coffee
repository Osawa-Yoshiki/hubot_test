module.exports = (robot) ->
  ...
  robot.respond /あいうえお/i, (msg) ->
    keyword = encodeURIComponent 'token=xoxp-239710252337-240366548533-243705275443-d27cea6cb5f5027450e4ebb2060195df&channel=%23general&username=motionbot&as_user=false&text=%e4%bb%8a%e9%80%b1%e3%81%ae%e8%a6%8b%e8%be%bc%e6%a1%88%e4%bb%b6%e3%82%92%e3%81%94%e9%80%a3%e7%b5%a1%e3%81%97%e3%81%be%e3%81%99&attachments=[{"text":"案件①：(0000352906/*****/Dr.Sum )\n案件②：( 0000368940/*****/MotionBoard)\n案件③：( 0000373052/*****/SVF )"}]'
    request = msg.http('https://slack.com/api/chat.postMessage')
                          .query(q: keyword)
                          .get()
